"""
SpectraSoft — Job 6: INT.2 Drift Corrected Intensity

This page displays drift-corrected intensities.

Workflow:
1. User enters sample name.
2. User presses Start one or more times to collect burns.
3. AnalysisWorker runs the same hardware/simulation flow as Job 5.
4. AnalysisWorker returns pre-correction intensities.
5. CorrectionEngine applies Page 4 drift correction:

       I_DC = k * (α * I + β)

6. The table displays drift-corrected intensity values.

Important:
- Raw ADC is not displayed here.
- Page 3 ISE/normalization happens in AnalysisWorker.
- Page 4 α, β, k correction happens through CorrectionEngine.
- Simulation from CSV still works through AnalysisWorker.
"""
...
class Job6RunPage(QWidget):
    """Job 6: INT.2 Drift Corrected Intensity page."""
    ...
    def __init__(self, main_window, group_id: int, group_name: str, job_type: str):
        ...
        # Each item is one corrected burn:
        # {"C": 95.911, "Si": 85.398, ...}
        self.results = []
    ...
    def _build_ui(self):
        ...
        self.title_label = QLabel(f"Job 6: INT.2 Drift Corrected - {self.group_name}")
    ...
    def _setup_job_ui(self):
        ...
        self.sample_name.setFixedWidth(220)
    ...
    def _update_table(self):
        if not self.element_names:
            ...
            self.status_label.setText(
                "No elements configured. Complete Page 3 before running Job 6."
            )
            return
    ...
    def _on_start(self):
        ...
        if not self.element_names:
            QMessageBox.warning(
                ...
                "Please complete Page 3 before running Job 6."
            )
            return
        ...
        self.status_label.setText("Starting drift-corrected analysis...")
        self.progress_bar.setValue(0)
    ...
    def _on_result(self, results: dict):
        """
        Receive pre-correction intensities from AnalysisWorker,
        apply Page 4 drift correction, then display corrected values.
        """
        ...
        self.status_label.setText(f"Burn {len(self.results)} complete. Drift correction applied.")
    ...
    def _generate_html_report(self) -> str:
        title = f"SpectraSoft Job 6 Drift Corrected Report - {self.group_name}"
        ...
        <body>
            ...
            <table class="meta">
                ...
                <tr>
                    <td><b>Job:</b> 6 / INT.2 Drift Corrected</td>
    ...
    def _on_export(self):
        ...
        path, _ = QFileDialog.getSaveFileName(
            ...
            "job6_drift_corrected_results.csv",
            "CSV Files (*.csv)"
        )
